    ...
    en: {
        translation: {
            ...
            "dashboard": {
                ...
                "exportHelp": "Use the VLESS link for V2Ray/Xray clients, or download a Clash profile for Clash Verge Rev and other Mihomo clients.",
                "vlessLinkLabel": "VLESS Link",
                "vlessLinkHint": "Import this link into v2rayN, v2rayNG, Shadowrocket, V2rayU, Hiddify, or another V2Ray/Xray client.",
                "copyVlessLink": "Copy VLESS Link",
                "clashProfileLabel": "Clash Profile",
                "clashProfileHint": "Download a ready-to-import Clash/Mihomo YAML profile for Clash Verge Rev and similar clients.",
                "downloadClashProfile": "Download Clash Profile",
                "clashImportHint": "In Clash Verge Rev, open Profiles and import this YAML as a local profile.",
                "copied": "Copied!",
                "downloaded": "Downloaded!",
                "copyFailed": "Clipboard access failed. Copy the VLESS link manually.",
                "clashExportError": "Unable to generate the Clash profile from the current connection.",
    ...
    zh: {
        translation: {
            ...
            "dashboard": {
                ...
                "subConfig": "订阅配置",
                "exportHelp": "V2Ray/Xray 客户端请使用 VLESS 链接；Clash Verge Rev 和其他 Mihomo 客户端请下载 Clash 配置。",
                "vlessLinkLabel": "VLESS 链接",
                "vlessLinkHint": "将此链接导入 v2rayN、v2rayNG、Shadowrocket、V2rayU、Hiddify 或其他 V2Ray/Xray 客户端。",
                "copyVlessLink": "复制 VLESS 链接",
                "clashProfileLabel": "Clash 配置",
                "clashProfileHint": "下载可直接导入 Clash Verge Rev 和其他类似客户端的 Clash/Mihomo YAML 配置。",
                "downloadClashProfile": "下载 Clash 配置",
                "clashImportHint": "在 Clash Verge Rev 中打开 Profiles，并将该 YAML 作为本地配置导入。",
                "copied": "已复制!",
                "downloaded": "已下载!",
                "copyFailed": "无法访问剪贴板，请手动复制 VLESS 链接。",
                "clashExportError": "无法根据当前连接生成 Clash 配置。",
                "liveMetrics": "实时连接指标",
                "assignedNode": "分配节点",
                "protocol": "协议",
                "assignedPort": "分配端口",
